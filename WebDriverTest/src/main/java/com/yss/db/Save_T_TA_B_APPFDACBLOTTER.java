...
public class Save_T_TA_B_APPFDACBLOTTER {
	...
	public MyResponse save_T_TA_B_APPFDACBLOTTER(){
		Common.logInfo("save_T_TA_B_APPFDACBLOTTER");
		
		MyResponse myResponse = new MyResponse();
		Connection con = DBConnect.getConnection();
		StringBuffer allJson = new StringBuffer();
		String[] key = {"FADDR","FINSTREPRIDCODE","FINSTREPRIDTYPE","FINSTREPRNAME","FAPPNO","FIDTYPE","FIDNO","FINVNAME",
		...
		try {
			ResultSet resultSet = con.prepareStatement("select * from T_TA_B_APPFDACBLOTTER").executeQuery();
